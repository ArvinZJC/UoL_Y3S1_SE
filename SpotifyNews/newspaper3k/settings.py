...
if getattr(sys, 'frozen', False):
    PARENT_DIRECTORY = os.path.dirname(sys.executable) # add to solve compatibility issues
elif __file__:
    PARENT_DIRECTORY = os.path.dirname(os.path.abspath(__file__)) # original code
